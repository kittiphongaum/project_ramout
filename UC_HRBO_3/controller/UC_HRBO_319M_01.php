...
$template->set_filenames(array(
    'body' => '../view/UC_HRBO_319M_01.html')
);
...
$model->membertype = "9003','9004','9005";
...
$rpt_url = $host_jasper_service . "/jasperserver/flow.html?j_username=" . $host_jasper_username . "&j_password=" . $host_jasper_password . "&_flowId=viewReportFlow&reportUnit=/reports/aomsinbo/UC_HRBO_319M_01&decorate=no";
$rpt_url .= "&output=pdf";
...
$rpt_url .= "&member_type=" . "9003,9004,9005";
...
$template->assign_var("member_type", isNotEmpty($model->membertype));
