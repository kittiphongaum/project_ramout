...
$template->set_filenames(array(
    'body' => '../view/UC_HRBO_319M_01v.html')
);
...
if ($data_by_id["status"] == "I" || $data_by_id["status"] == "D") {
...
$set_doc_emp->doc_no   = isNotEmpty($data_by_id["doc_no"]);
$set_doc_emp->emp_id   = isNotEmpty($data_by_id["emp_id"]);
$set_doc_emp->category = "beneficiary";
$set_doc_emp->name     = "PENSION_";

$data = array(
    "menu_item" => 3,
    "doc_emp"   => base64_encode(json_encode($set_doc_emp)),
);
